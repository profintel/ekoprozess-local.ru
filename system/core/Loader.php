...
class CI_Loader {
	...
	protected $_ci_components_paths = array();
	...
	public function __construct()
	{
		...
		$this->_ci_model_paths = array(APPPATH .'models/', APPPATH .'components/');
		$this->_ci_components_paths = array(APPPATH .'components/');
	...
	public function component($component) {
		...
		foreach ($this->_ci_components_paths as $path) {
			if (!file_exists($path . $name .'/'. $class .'.php')) {
				continue;
			}
      
			if (!class_exists('CI_Component')) {
				load_class('Component', 'core');
			}
      ...
      $CI->$name->params = $component;
		...
		show_error('Unable to locate the component you have specified: '. $name);
	}
