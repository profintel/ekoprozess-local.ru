...
<? if(isset($client_id)&&$client_id) {?>
  <a class="btn btn-xs btn-primary pull-right" href="/admin/acceptances/?date_start=1970-01-01&client_id=<?=$client_id;?><?=($client_child_id ? '&client_child_id='.$client_child_id : '');?>">Перейти к актам клиента</a>
<? } ?>
</div>